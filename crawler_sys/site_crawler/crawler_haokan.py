...
if __name__ == '__main__':
    ...
    releaserUrl = 'https://haokan.baidu.com/haokan/wiseauthor?app_id=221574041888774827'
    # releaserUrl1 = 'https://haokan.hao123.com/haokan/wiseauthor?app_id=1593559247255945'
    # 看剧汪星人
    test = crawler.releaser_page(releaserUrl, output_to_es_raw=True, es_index='crawler-data-raw',
                                              doc_type='doc',
