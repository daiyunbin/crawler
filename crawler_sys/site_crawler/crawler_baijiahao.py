...
class Crawler_baijiahao():
    ...
    def releaser_page_web(self, releaserUrl,
        ...
        def get_page_info():
            page_info = requests.get(url, headers=headers,proxies=proxies,timeout=3)
        ...
        def get_data_list(uk, releaser, Hmery_Time, ctime):
            ...
            if data_lis:
                for single_data in data_lis:
                    ...
                    data_dic["release_time"] = int(single_data["itemData"]["created_at"]*1e3)
        ...
        while page_num <= releaser_page_num_max and has_more:
            try:
                ...
                for interact in interact_res_json:
                    ...
                    single_data = None
                    single_data = copy.deepcopy(data_list_dic[interact])
                    result_lst.append(single_data)
            except:
                proxies = get_proxy(1)
                count_false += 1
                if count_false <= 5:
    ...
    def releaser_dynamic_page_web(self, releaserUrl,
                          output_to_file=False,
                          filepath=None,
                          releaser_page_num_max=30,
                          output_to_es_raw=False,
    ...
    def releaser_page(self, releaserUrl,
                      ...
                      doc_type=None,
                      fetchFavoriteCommnt=True,proxies_num=None):
        self.releaser_page_web(releaserUrl,output_to_file=output_to_file,
                      filepath=filepath,
...
if __name__ == '__main__':
    ...
    releaserUrl = 'https://haokan.baidu.com/haokan/wiseauthor?app_id=1565285080839434'
    ...
    test = crawler.releaser_dynamic_page_web(releaserUrl, output_to_es_raw=True, es_index='crawler-data-raw',
                                 doc_type='doc',
                                 releaser_page_num_max=50)
