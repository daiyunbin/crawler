...
class Crawler_Tencent_News():
    ...
    def build_qnrid_and_qnsig(self, cgi='searchMore'):
        str_dict = {}
        end_str = ''
        qnrid = copy.deepcopy(self.qnrid)
        str_dict['appver'] = self.appver
        str_dict['devid'] = self.devid
        str_dict['cgi'] = cgi
        str_dict['qn-rid'] = self.qnrid
        str_dict['secret'] = 'qn123456'
        new_list_sort = sorted(str_dict.items(), key=lambda x: x[0])
        for one in new_list_sort:
            # print(one)
            end_str = end_str + one[0] + '=' + one[1] + '&'
        end_str = end_str[0:-1]
        md5 = hashlib.md5()
        md5.update(end_str.encode())
        qnsig = md5.hexdigest()
        return (qnrid, qnsig)
    ...
    def get_releaser_follower_num(self, releaserUrl):
        ...
        head = {
                ...
                "qn-sig": "50f7ac16c3aa3aa115e6ce5a415ccc92",
                "qn-rid": "4bafdaef-af5e-442e-9bb2-c1feb525894b"}
        try:
    ...
    def search_video_page(self, keyword, releaser_url,releaser=True,
        ...
        for search_type in search_request_dict:
            ...
            for page in range(1, search_pages_max):
                ...
                para_dict['qn-rid'] = qnrid
                para_dict['qn-sig'] = qnsig
                body['page'] = page
        ...
        while has_more and count <= releaser_page_num_max and releaser_id:
            ...
            if data_list == []:
                ...
                for one_video in data_list:
                    ...
                    video_dic['releaser'] = one_video.get('source')
    ...
    def list_page_for_main_page(self,
        ...
        while count < list_page_max:
            ...
            qnrid, qnsig = self.build_qnrid_and_qnsig()
            query_dict['qn-sig'] = qnsig
            query_dict['qn-rid'] = qnrid
            headers['qn-sig'] = qnsig
            headers['qn-rid'] = qnrid
...
if __name__ == "__main__":
    ...
    url =[ {"platform": "腾讯新闻",
     "url": "https://view.inews.qq.com/media/5486130",
     "releaser": "芒果都市"
     }]
    ...
    start_time = 1563700159000
    end = 1564391359000
    t.time_range_video_num(start_time, end, url)
