...
def func_write_into_monthly_index_new_released(line_list, doc_type, index='short-video-production-2019'):
    count = 0
    bulk_all_body = ''
    re_list = []
...
re_s_t = 1572537600000
re_e_t = 1575129600000
miaopai_list = []
monthly_doc_type_name = 'daily-url-2019-11-30'
            ...
            search_body = {
                "query": {
                    "bool": {
                       ...
                       #  {"range": {"fetch_time": {"lte": 1571068800000}}}
                        ]
                    }
                }
            }
