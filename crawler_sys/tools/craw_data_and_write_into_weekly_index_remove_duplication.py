...
# weekly_doc_type_name = "daily-url-2019_w39_s1"
# re_s_t =1569081600000
# re_e_t =1569686400000
miaopai_list = []
file = r'D:\work_file\发布者账号\anhui.csv'
#file = r'D:\work_file\发布者账号\month9month8_releaser_video_num预警 2019-10-06.csv'
...
for releaser in miaopai_list:
   ...
   for one_scan in scan_re:
       doc_id = cal_doc_id(one_scan["_source"]["platform"], url=one_scan["_source"]["url"], doc_id_type='all-time-url',
